  ...
  useEffect(() => {
    ...
    return(
        ...
        <div className={`${className} flex flex-col p-5`}>
            ...
            <div className="mb-2 text-sm">{data.name == "" ? <span className="text-muted-foreground font-medium">[name]</span> : data.name == "@" ? <span className="font-bold">{data.domain}</span> : <span className="font-bold">{`${data.name}.${data.domain}`}</span>} points to {data.types.A.address == "" ? <span className="text-muted-foreground font-medium">{data.type == "A" ? "[IPv4 address]" : "[IPv6 address]"}</span> : <span className="font-bold">{data.types.A.address}</span>} {data.proxyStatus ? "and has its traffic proxied through Cloudflare." : ""}</div>
            :
            data.type == "CAA" ?
            <div className="mb-2 text-sm">{data.types.CAA.domain_name == "" ? <span className="text-muted-foreground font-medium">[domain name]</span> : <span className="font-bold">{data.types.CAA.domain_name}</span>} can issue certificates for {data.name == "" ? <span className="text-muted-foreground font-medium">[name]</span> : data.name == "@" ? <span className="font-bold">{data.domain}</span> : <span className="font-bold">{`${data.name}.${data.domain}`}</span>} and <span className="font-bold">{data.types.CAA.tag == 'issue' ? "only allow specific hostnames" : data.types.CAA.tag == 'issuewild' ? "only allow wildcards" : "sends violation reports to URL (http:, https:, or mailto:)"}.</span></div>
            :
            data.type == "CERT" ?
            <div className="mb-2 text-sm">{data.name == "" ? <span className="text-muted-foreground font-medium">[name]</span> : data.name == "@" ? <span className="font-bold">{data.domain}</span> : <span className="font-bold">{`${data.name}.${data.domain}`}</span>} has certificate type {<span className="text-muted-foreground font-medium">[cert. type]</span>} and a public key encrypted with {<span className="text-muted-foreground font-medium">[algorithm]</span>}.</div>
            :
            data.type == "CNAME" ?
            <div className="mb-2 text-sm">{data.name == "" ? <span className="text-muted-foreground font-medium">[name]</span> : data.name == "@" ? <span className="font-bold">{data.domain}</span> : <span className="font-bold">{`${data.name}.${data.domain}`}</span>} is an alias of {data.types.CNAME.target == "" ? <span className="text-muted-foreground font-medium">[target]</span> : <span className="font-bold">{data.types.CNAME.target}</span>} and has its traffic proxied through Cloudflare.</div>
            :
            data.type == "DNSKEY" ?
            <div className="mb-2 text-sm">{data.name == "" ? <span className="text-muted-foreground font-medium">[name]</span> : data.name == "@" ? <span className="font-bold">{data.domain}</span> : <span className="font-bold">{`${data.name}.${data.domain}`}</span>} verifies DNSSEC with a public key encrypted with {<span className="text-muted-foreground font-medium">[algorithm]</span>}.</div>
            :
            data.type == "DS" ?
            <div className="mb-2 text-sm">{data.name == "" ? <span className="text-muted-foreground font-medium">[name]</span> : data.name == "@" ? <span className="font-bold">{data.domain}</span> : <span className="font-bold">{`${data.name}.${data.domain}`}</span>} has a DNSSEC key with ID {data.types.DS.key_tag == "" ? <span className="text-muted-foreground font-medium">[key tag]</span> : <span className="font-bold">{data.types.DS.key_tag}</span>} and public key hashed by {data.types.DS.digest_type == "" ? <span className="text-muted-foreground font-medium">[digest type]</span> : data.types.DS.digest_type == "1" ? <span className="font-bold">SHA-1</span> : data.types.DS.digest_type == "2" ? <span className="font-bold">SHA-256</span> : data.types.DS.digest_type == "3" ? <span className="font-bold">GOST R 34,11-94</span> : <span className="font-bold">SHA-384</span>} for a DNSKEY record using {<span className="text-muted-foreground font-medium">[algorithm]</span>}.</div>
            :
            data.type == "HTTPS" ?
            <div className="mb-2 text-sm">{data.name == "" ? <span className="text-muted-foreground font-medium">[name]</span> : data.name == "@" ? <span className="font-bold">{data.domain}</span> : <span className="font-bold">{`${data.name}.${data.domain}`}</span>} refers to {data.types.HTTPS.target == "" ? <span className="text-muted-foreground font-medium">[target]</span> : <span className="font-bold">{data.types.HTTPS.target}</span>} with priority {data.types.HTTPS.priority == "" ? <span className="text-muted-foreground font-medium">[priority]</span> : <span className="font-bold">{data.types.HTTPS.priority}</span>}.</div>
            :
            data.type == "LOC" ?
            <div className="mb-2 text-sm">{data.name == "" ? <span className="text-muted-foreground font-medium">[name]</span> : data.name == "@" ? <span className="font-bold">{data.domain}</span> : <span className="font-bold">{`${data.name}.${data.domain}`}</span>} has location information <span className="font-bold">{data.types.LOC.latitude_degrees == "" ? "0" : data.types.LOC.latitude_degrees} {data.types.LOC.latitude_minutes == "" ? "0" : data.types.LOC.latitude_minutes} {data.types.LOC.latitude_seconds == "" ? "0" : data.types.LOC.latitude_seconds} {data.types.LOC.latitude_direction} {data.types.LOC.longitude_degrees == "" ? "0" : data.types.LOC.longitude_degrees} {data.types.LOC.longitude_minutes == "" ? "0" : data.types.LOC.longitude_minutes} {data.types.LOC.longitude_seconds == "" ? "0" : data.types.LOC.longitude_seconds} {data.types.LOC.longitude_direction} {data.types.LOC.altitude == "" ? "0m" : data.types.LOC.altitude + "m"} {data.types.LOC.size == "" ? "0m" : data.types.LOC.size + "m"} {data.types.LOC.horizontal == "" ? "0m" : data.types.LOC.horizontal + "m"} {data.types.LOC.vertical == "" ? "0m" : data.types.LOC.vertical + "m"}.</span></div>
            :
            data.type == "MX" ?
            <div className="mb-2 text-sm">{data.types.MX.mail == "" ? <span className="text-muted-foreground font-medium">[mail server]</span> : <span className="font-bold">{data.types.MX.mail}</span>} handles mail for {data.name == "" ? <span className="text-muted-foreground font-medium">[name]</span> : data.name == "@" ? <span className="font-bold">{data.domain}</span> : <span className="font-bold">{`${data.name}.${data.domain}`}</span>}.</div>
            :
            data.type == "NAPTR" ?
            <div className="mb-2 text-sm">
                {data.types.NAPTR.flags == "S" ? <span>{data.name == "" ? <span className="text-muted-foreground font-medium">[name]</span> : data.name == "@" ? <span className="font-bold">{data.domain}</span> : <span className="font-bold">{`${data.name}.${data.domain}`}</span>} returns a URI record against which a successive NAPTR lookup should be conducted.</span> : data.types.NAPTR.flags == "U" ? <span>{data.name == "" ? <span className="text-muted-foreground font-medium">[name]</span> : data.name == "@" ? <span className="font-bold">{data.domain}</span> : <span className="font-bold">{`${data.name}.${data.domain}`}</span>} returns a record that specifies how to resolve a given SRV record.</span> : <span>{data.name == "" ? <span className="text-muted-foreground font-medium">[name]</span> : data.name == "@" ? <span className="font-bold">{data.domain}</span> : <span className="font-bold">{`${data.name}.${data.domain}`}</span>}  returns content {data.types.NAPTR.order == "" && data.types.NAPTR.flags == "" && data.types.NAPTR.preference == "" && data.types.NAPTR.regEx == "" && data.types.NAPTR.replacement == "" && data.types.NAPTR.service == "" ? <span className="text-muted-foreground font-medium">[content]</span> : <span className="font-bold">{data.types.NAPTR.order} {data.types.NAPTR.preference} {data.types.NAPTR.flags} {data.types.NAPTR.service} {data.types.NAPTR.regEx} {data.types.NAPTR.replacement}</span>}.</span>}
            </div>
            :
            data.type == "NS" ?
            <div className="mb-2 text-sm">{data.name == "" ? <span className="text-muted-foreground font-medium">[name]</span> : data.name == "@" ? <span className="font-bold">{data.domain}</span> : <span className="font-bold">{`${data.name}.${data.domain}`}</span>} is managed by {data.types.NS.nameserver == "" ? <span className="text-muted-foreground font-medium">[nameserver]</span> : <span className="font-bold">{data.types.NS.nameserver}</span>}.</div>
            :
            data.type == "PTR" ?
            <div className="mb-2 text-sm"> {data.types.PTR.domain == "" ? <span className="text-muted-foreground font-medium">[domain name]</span> : data.types.PTR.domain == "@" ? <span className="font-bold">{data.domain}</span> : <span className="font-bold">{data.types.PTR.domain}</span>} points to {data.name == "" ? <span className="text-muted-foreground font-medium">[name]</span> : data.name == "@" ? <span className="font-bold">{data.domain}</span> : <span className="font-bold">{`${data.name}.${data.domain}`}</span>} in a reverse lookup.</div>
            :
            data.type == "SMIMEA" ?
            <div className="mb-2 text-sm">{data.name == "" ? <span className="text-muted-foreground font-medium">[name]</span> : data.name == "@" ? <span className="font-bold">{data.domain}</span> : <span className="font-bold">{`${data.name}.${data.domain}`}</span>} has an association with <span className="text-muted-foreground font-medium">[selector]</span> using <span className="text-muted-foreground font-medium">[matching type]</span> and a <span className="text-muted-foreground font-medium">[usage]</span>.</div>
            :
            data.type == "SRV" ?
            <div className="mb-2 text-sm">{data.name == "" ? <span className="text-muted-foreground font-medium">[name]</span> : data.name == "@" ? <span className="font-bold">{data.domain}</span> : <span className="font-bold">{`${data.name}.${data.domain}`}</span>} points to {data.types.SRV.target == "" ? <span className="text-muted-foreground font-medium">[target]</span> : <span className="text-muted-foreground font-medium">{data.types.SRV.target}</span>} and listens on {data.types.SRV.port == "" ? <span className="text-muted-foreground font-medium">[port]</span> : <span className="font-bold">{data.types.SRV.port}</span>}.</div>
            :
            data.type == "SSHFP" ?
            <div className="mb-2 text-sm">{data.name == "" ? <span className="text-muted-foreground font-medium">[name]</span> : data.name == "@" ? <span className="font-bold">{data.domain}</span> : <span className="font-bold">{`${data.name}.${data.domain}`}</span>} uses <span className="text-muted-foreground font-medium">[algorithm]</span> with <span className="text-muted-foreground font-medium">[fingerprint type]</span> fingerprint {data.types.SSHFP.fingerprint == ""? <span className="text-muted-foreground font-medium">[fingerprint]</span> : <span className="font-bold">{data.types.SSHFP.fingerprint}</span>}.</div>
            :
            data.type == "SVCB" ?
            <div className="mb-2 text-sm">{data.name == "" ? <span className="text-muted-foreground font-medium">[name]</span> : data.name == "@" ? <span className="font-bold">{data.domain}</span> : <span className="font-bold">{`${data.name}.${data.domain}`}</span>} refers to {data.types.SVCB.target == "" ? <span className="text-muted-foreground font-medium">[target]</span> : <span className="font-bold">{data.types.SVCB.target}</span>} with priority {data.types.SVCB.priority == "" ? <span className="text-muted-foreground font-medium">[priority]</span> : <span className="font-bold">{data.types.SVCB.priority}</span>}.</div>
            :
            data.type == "TLSA" ?
            <div className="mb-2 text-sm">{data.name == "" ? <span className="text-muted-foreground font-medium">[name]</span> : data.name == "@" ? <span className="font-bold">{data.domain}</span> : <span className="font-bold">{`${data.name}.${data.domain}`}</span>} has an association with <span className="text-muted-foreground font-medium">[selector]</span> using <span className="text-muted-foreground font-medium">[matching type]</span> and a <span className="text-muted-foreground font-medium">[usage]</span>.</div>
            :
            data.type == "TXT" ?
            <div className="mb-2 text-sm">{data.name == "" ? <span className="text-muted-foreground font-medium">[name]</span> : data.name == "@" ? <span className="font-bold">{data.domain}</span> : <span className="font-bold">{`${data.name}.${data.domain}`}</span>} has a record with content {data.types.TXT.сontent == "" ? <span className="text-muted-foreground font-medium">[content]</span> : <span className="font-bold">{data.types.TXT.сontent}</span>}.</div>
            :
            data.type == "URI" ?
            <div className="mb-2 text-sm">{data.name == "" ? <span className="text-muted-foreground font-medium">[name]</span> : data.name == "@" ? <span className="font-bold">{data.domain}</span> : <span className="font-bold">{`${data.name}.${data.domain}`}</span>} points to {data.types.URI.target == "" ? <span className="text-muted-foreground font-medium">[target]</span> : <span className="font-bold">{data.types.URI.target}</span>}.</div>
            :
